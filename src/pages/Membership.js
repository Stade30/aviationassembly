  ...
  return (
    <div className="relative group">
      ...
      {isOpen && (
        <div
          className="
          absolute right-0 mt-2 w-44 rounded-lg bg-black text-white-700 shadow-lg z-[999]
        ...
        >
          <Link
            ...
            className="block px-4 py-2 text-sm text-topnavbg transform transition-transform duration-300 ease-in-out hover:scale-105"
          >
            Login
          </Link>
